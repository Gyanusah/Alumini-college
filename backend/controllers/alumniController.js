...
//     getConnectionStats as getConnectionStatsService, // 👈 renamed to avoid conflict
...
// export const getAlumniByBranch = asyncHandler(async (req, res, next) => {
...
// export const getAlumniByCompany = asyncHandler(async (req, res, next) => {
...
// export const getAlumniBySkills = asyncHandler(async (req, res, next) => {
...
// export const acceptAlumniConnection = asyncHandler(async (req, res, next) => {
//     const connection = await acceptAlumniConnection(req.params.id, req.user.id);
...
// // 📊 Connection stats (fixed name)
// export const getConnectionStats = asyncHandler(async (req, res, next) => {
...
// export const getMentorshipConnectionsController = asyncHandler(async (req, res, next) => {
...
// export const updateMentorshipDetails = asyncHandler(async (req, res, next) => {
...
// // 📈 Alumni statistics
// export const getAlumniStats = asyncHandler(async (req, res, next) => {
